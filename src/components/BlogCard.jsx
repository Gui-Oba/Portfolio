...
export default function BlogCard({ title, description, date, to }) {
  return (
    <Link
      to={to}
      className="group block bg-white rounded-2xl shadow-lg transition-transform hover:-translate-y-1 p-6 text-left"
    >
      <h3 className="text-xl font-semibold text-gray-900 group-hover:underline">{title}</h3>
